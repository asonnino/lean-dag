import LeanDag.HammerheadTwo.Ledger.Statement
import LeanDag.HammerheadTwo.Agreement.Proof
import LeanDag.HammerheadTwo.Helpers.Ledger

/-!
# HH5 — proof

Generated proof layer; not part of the audit surface. Agreement is HH3
