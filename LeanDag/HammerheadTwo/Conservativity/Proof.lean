import LeanDag.HammerheadTwo.Conservativity.Statement
import LeanDag.HammerheadTwo.Helpers.Schedule

/-!
# HH6 — proof

Generated proof layer; not part of the audit surface. HH6a is an
induction along `update` under the constant rule; HH6b transports each
