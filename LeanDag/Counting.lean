...
`dos-equivocation-and-growth.md` §4 and §10, results **D5**, **D6**, **D19a**
and **D19b**.
...
it over an arbitrary `Finset` is deliberate: §11's design point is that
...
all. This is the sharpest constraint the condition supplies, and the starting
point of §10's candidate proof B. -/
