...
/-!
# The `3f + 1` pair's liveness — proof

Generated proof layer; not part of the audit surface. Each conjunct is
the helper of the same name in `Helpers/MahiMahiPair/Liveness.lean`, or
in `Helpers/Liveness.lean` for the two claims about the schedule alone.
-/
