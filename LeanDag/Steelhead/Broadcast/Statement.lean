...
* **SH17c, validity** — "if an honest validator proposes a block, all
  ...
  otherwise;
* **SH17d, validity under asynchrony** — the same clause read off the
...
* **SH17e, total order** — "if an honest validator commits `b` before
...
SH17a and SH17e assume `2 ≤ w κ`, what the laws need; SH17b assumes
nothing of the wave; SH17c and SH17d read no wave, since a committed
