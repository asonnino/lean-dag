...
block map back at the rounds of its blocks: at `I = 4`, `K = 2` and `j₀ = 0`, with the blocks
opening every interval (`q = 1`), block `0` opens interval `2` at rounds `9` and `10`, block `1`
interval `3` at rounds `13` and `14`; at `q = 2` block `1` opens interval `4` instead, at rounds
`17` and `18`. -/
...
example : blockRound 4 1 0 0 0 = 9 := by decide
example : blockRound 4 1 0 1 1 = 14 := by decide
example : coinOfBlocks 4 1 0 shBlocks 0 9 = 1 := by decide
example : coinOfBlocks 4 1 0 shBlocks 0 10 = 2 := by decide
example : coinOfBlocks 4 1 0 shBlocks 0 14 = 0 := by decide
-- Round `11` lies in no block, so the map draws the default.
example : coinOfBlocks 4 1 0 shBlocks 3 11 = 3 := by decide
-- At stride `2` the second block opens two intervals up, and round `14` lies in no block.
example : blockRound 4 2 0 1 1 = 18 := by decide
example : coinOfBlocks 4 2 0 shBlocks 0 18 = 0 := by decide
example : coinOfBlocks 4 2 0 shBlocks 3 14 = 3 := by decide
