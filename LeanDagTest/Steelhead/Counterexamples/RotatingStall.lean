...
* **Algorithm 3 answers period `4` at every anchor**, at every horizon and whatever the anchor
...
/-- **Algorithm 3 answers period `4` at every anchor** of `rtDag N`, at hysteresis `1/2` and
