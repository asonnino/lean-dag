...
-- The rule is the composite of Mahi-Mahi's rule at each kind's wave, by definition (SH-MM16c).
...
whoever led the slot that carried it. SH17d's conclusion on data. -/
