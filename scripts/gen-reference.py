...
LAYERS = [
    ...
    ("Hammerhead 2.0: the adaptive leader count",
     ["HammerheadTwo.Model.Rule", "HammerheadTwo.Model.Schedule",
      "HammerheadTwo.Model.Window", "HammerheadTwo.Model.Run",
      "HammerheadTwo.Model.Live", "HammerheadTwo.Model.Heads",
      "HammerheadTwo.Window.Statement", "HammerheadTwo.Agreement.Statement",
      "HammerheadTwo.Ledger.Statement", "HammerheadTwo.Conservativity.Statement",
      "HammerheadTwo.Aimd.Statement", "HammerheadTwo.Progress.Statement",
      "HammerheadTwo.Heads.Statement", "HammerheadTwo.Mysticeti.Statement",
      "HammerheadTwo.MysticetiLive.Statement", "HammerheadTwo.Odontoceti.Statement",
      "HammerheadTwo.Nemo.Statement", "HammerheadTwo.Helpers.Schedule",
      "HammerheadTwo.Helpers.Mysticeti", "HammerheadTwo.Helpers.Agreement",
      "HammerheadTwo.Helpers.Ledger", "HammerheadTwo.Helpers.Progress",
      "HammerheadTwo.Helpers.Heads", "HammerheadTwo.Helpers.MysticetiLive",
      "HammerheadTwo.Helpers.Odontoceti", "HammerheadTwo.Helpers.Nemo",
      "HammerheadTwo.Helpers.NemoLive", "HammerheadTwo.Window.Proof",
      "HammerheadTwo.Agreement.Proof", "HammerheadTwo.Ledger.Proof",
      "HammerheadTwo.Conservativity.Proof", "HammerheadTwo.Aimd.Proof",
      "HammerheadTwo.Progress.Proof", "HammerheadTwo.Heads.Proof",
      "HammerheadTwo.Mysticeti.Proof", "HammerheadTwo.MysticetiLive.Proof",
      "HammerheadTwo.Odontoceti.Proof", "HammerheadTwo.Nemo.Proof"]),
