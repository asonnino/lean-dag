...
LAYERS = [
    ...
    ("Steelhead: two rules at one wavelength function",
     ["Steelhead.Model.Wavelength", "Steelhead.Model.Decision",
      ...
      "Steelhead.Model.Clauses", "Steelhead.Model.Timeout",
      "Steelhead.Safety.Statement", "Steelhead.Liveness.Statement",
      "Steelhead.MahiMahiPair.Safety.Statement", "Steelhead.BlueBottlePair.Safety.Statement",
      "Steelhead.MahiMahiPair.Liveness.Statement",
      "Steelhead.BlueBottlePair.Liveness.Statement",
      "Steelhead.Period.Statement", "Steelhead.MahiMahiPair.Period.Statement",
      "Steelhead.BlueBottlePair.Period.Statement",
      "Steelhead.Coin.Statement", "Steelhead.MahiMahiPair.Coin.Statement",
      "Steelhead.BlueBottlePair.Coin.Statement",
      ...
      "Steelhead.MahiMahiPair.Replay.Statement", "Steelhead.MahiMahiPair.Timeout.Statement",
      "Steelhead.MahiMahiPair.Broadcast.Statement",
      "Steelhead.BlueBottlePair.Broadcast.Statement",
      "Steelhead.Helpers.Decision", "Steelhead.Helpers.Safety", "Steelhead.Helpers.Liveness",
      "Steelhead.Helpers.MahiMahiPair.Liveness",
      "Steelhead.Helpers.BlueBottlePair.Liveness",
      "Steelhead.Helpers.Period", "Steelhead.Helpers.MahiMahiPair.Period",
      "Steelhead.Helpers.BlueBottlePair.Period",
      "Steelhead.Helpers.Coin", "Steelhead.Helpers.MahiMahiPair.Coin",
      "Steelhead.Helpers.BlueBottlePair.Coin",
      "Steelhead.Helpers.Compose", "Steelhead.Helpers.MahiMahiPair",
      "Steelhead.Helpers.BlueBottlePair", "Steelhead.Helpers.Broadcast",
      "Steelhead.Helpers.Reactive", "Steelhead.Helpers.Replay",
      "Steelhead.Helpers.MahiMahiPair.Replay", "Steelhead.Helpers.MahiMahiPair.Timeout",
      "Steelhead.Properties",
      "Steelhead.Safety.Proof", "Steelhead.Liveness.Proof",
      "Steelhead.MahiMahiPair.Safety.Proof", "Steelhead.BlueBottlePair.Safety.Proof",
      "Steelhead.MahiMahiPair.Liveness.Proof", "Steelhead.BlueBottlePair.Liveness.Proof",
      "Steelhead.Period.Proof", "Steelhead.MahiMahiPair.Period.Proof",
      "Steelhead.BlueBottlePair.Period.Proof",
      "Steelhead.Coin.Proof", "Steelhead.MahiMahiPair.Coin.Proof",
      "Steelhead.BlueBottlePair.Coin.Proof",
      "Steelhead.Ledger.Proof", "Steelhead.Interface.Proof",
      "Steelhead.MahiMahiPair.Ledger.Proof", "Steelhead.BlueBottlePair.Ledger.Proof",
      "Steelhead.MahiMahiPair.Proof", "Steelhead.BlueBottlePair.Proof",
      "Steelhead.Broadcast.Proof", "Steelhead.Replay.Proof",
      "Steelhead.MahiMahiPair.Replay.Proof", "Steelhead.MahiMahiPair.Timeout.Proof",
      "Steelhead.MahiMahiPair.Broadcast.Proof", "Steelhead.BlueBottlePair.Broadcast.Proof"]),
    ("Async BlueBottle: the two-round rule at a three-round wave",
     ["AsyncBlueBottle.Model.Rules", "AsyncBlueBottle.Model.Decision",
      "AsyncBlueBottle.Model.Good", "AsyncBlueBottle.Model.Unpredictable",
      "AsyncBlueBottle.Safety.Statement", "AsyncBlueBottle.Counting.Statement",
      "AsyncBlueBottle.Liveness.Statement", "AsyncBlueBottle.Synchrony.Statement",
      "AsyncBlueBottle.Helpers.Rules", "AsyncBlueBottle.Helpers.Decision",
      "AsyncBlueBottle.Helpers.Counting", "AsyncBlueBottle.Helpers.Liveness",
      "AsyncBlueBottle.Helpers.Synchrony", "AsyncBlueBottle.Safety.Proof",
      "AsyncBlueBottle.Counting.Proof", "AsyncBlueBottle.Liveness.Proof",
      "AsyncBlueBottle.Synchrony.Proof", "AsyncBlueBottle.Carrier",
      "AsyncBlueBottle.Properties", "AsyncBlueBottle.Record"]),
